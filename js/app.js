...
var allModels = [{modelName: 'Attacker fish', modelURL: unloadedPhoto, difficulty: 6.5, tags: ['Living', 'Attacker'], description: 'null', webLink: '/attacker-fish'}, {modelName: 'Sea shrimp', modelURL: 'https://pitchk.github.io/h/shrimp.jpg', difficulty: 5.5, tags: ['Living', 'Attacker'], description: 'A small shrimp, complete with two front claws and its distinguishable flexible tail.', webLink: '/shrimp'}];
